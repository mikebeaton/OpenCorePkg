...
STATIC
EFI_STATUS
ExternalBootActionDoLegacyBoot (
  IN OUT  OC_PICKER_CONTEXT         *PickerContext,
  ...
  )
{
  ...
  for (HandleIndex = 0; HandleIndex < NoHandles; HandleIndex++) {
    ...
    PickerEntry->ExternalBootAction         = ExternalBootActionDoLegacyBoot;
    PickerEntry->ExternalBootGetDevicePath  = ExternalBootGetDevicePath;
    PickerEntry->ExternalDevicePath         = BlockDevicePath;
