...
#ifndef APPLE_USER_INTERFACE_PROTOCOL_H
#define APPLE_USER_INTERFACE_PROTOCOL_H
...
**/
#define APPLE_USER_INTERFACE_PROTOCOL_GUID \
  { 0x691E1AF0, 0x8673, 0x4C98,           \
    { 0xA9, 0xB3, 0x04, 0x26, 0x20, 0xE9, 0x14, 0x98 }}

// Version in MacPro5,1 144.0.0.0.0 firmware
#define APPLE_USER_INTERFACE_PROTOCOL_REVISION  0x00000004

typedef struct APPLE_USER_INTERFACE_PROTOCOL_ APPLE_USER_INTERFACE_PROTOCOL;
...
struct APPLE_USER_INTERFACE_PROTOCOL_ {
  UINTN                               Revision;
...
extern EFI_GUID gAppleUserInterfaceProtocolGuid;

#endif // APPLE_USER_INTERFACE_PROTOCOL_H
